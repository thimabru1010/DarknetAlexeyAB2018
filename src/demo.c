...
void *detect_in_thread(void *ptr)
{
	...
	*/
	...
	// 	if(copy_img == NULL) copy_img = cvCreateImage(cvSize(det_img->width, det_img->height), det_img->depth, det_img->nChannels);
	// 	cvCopy(det_img, copy_img, 0);
	// }
	// static int img_id = 0;
	// img_id++;
	// char image_name[1024];
	// sprintf(image_name, "result_img/img_%d_%d_%d.jpg", frame_id, img_id);
